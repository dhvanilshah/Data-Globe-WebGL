(function() {
  ...
  function handleMouseMove(event) {
    ...
    if (mouseLeftDown) {
      ...
      elevation = Math.min(
        Math.max(elevation, -Math.PI / 2 + 0.001),
        Math.PI / 2 - 0.001
      );
    } else {
      radius += 0.01 * deltaY;
  ...
  initializeTexture(
    dayTex,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/earthmap.png"
  );
  initializeTexture(
    bumpTex,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/earthbump.png"
  );
  initializeTexture(
    cloudTex,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/earthcloud.png"
  );
  initializeTexture(
    transTex,
  ...
  switch (data) {
    case "lightpollution":
      initializeTexture(
        lightTex,
        "https://gist.githubusercontent.com/jashkenas/491922f09a148f211de24ea3777207fa/raw/a8ce7f75f1f30d689b990e1b7a0ff46384c4c742/nightsky.jpg"
      );
      break;
    default:
      initializeTexture(
        lightTex,
        "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/earthlight.png"
      );
      break;
  }
  ...
  initializeTexture(
    specTex,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/earthspec.png"
  );
  initializeTexture(
    waterBump,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/normalmap.png"
  );
  initializeTexture(
    waterSpec,
    "https://raw.githubusercontent.com/dhvanilshah/Data-Globe-WebGL/master/images/wavemap18.png"
  );
  ...
  switch (sky) {
    ...
    default:
      skyboxFaces[0] = [gl.TEXTURE_CUBE_MAP_POSITIVE_X, "/"];
      skyboxFaces[1] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_X, "/"];
      skyboxFaces[2] = [gl.TEXTURE_CUBE_MAP_POSITIVE_Y, "/"];
      skyboxFaces[3] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_Y, "/"];
      skyboxFaces[4] = [gl.TEXTURE_CUBE_MAP_POSITIVE_Z, "/"];
      skyboxFaces[5] = [gl.TEXTURE_CUBE_MAP_NEGATIVE_Z, "/"];
      break;
  }
